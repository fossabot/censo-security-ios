...
struct HelpButton: View {
    ...
    private func createActionSheet() -> ActionSheet {
        ...
        buttons.append(ActionSheet.Button.default(Text("Get Support")) {
            if let supportURL = URL(string: "https://support.censocustody.com"), app.canOpenURL(supportURL) {
                app.open(supportURL)
            }
        })
        ...
        return ActionSheet(title: Text("Contact Censo Custody, Inc."), message: nil, buttons: buttons)
    }
}
